    ...
    <div class="flex-grow-1 overflow-auto custom-scrollbar">
        <ul class="nav nav-pills flex-column mb-auto p-3 gap-1">
            ...
            <?php if (in_array($tipoUsuario, [ROL_ADMINISTRADOR, ROL_SECRETARIO_TECNICO])): ?>
                ...
                <li class="nav-item">
                    <a href="index.php?action=reuniones_dashboard" class="nav-link <?php echo ($paginaActual == 'reuniones_dashboard' || $paginaActual == 'reunion_form') ? 'active' : ''; ?>">
                        <i class="fas fa-calendar-check fa-fw me-2"></i> Planificar Reuniones
                    </a>
                </li>
