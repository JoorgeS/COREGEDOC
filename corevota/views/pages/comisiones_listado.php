...
<head>
    ...
    <style>
        ...
        .table tbody tr td:nth-child(2) { width: 100%; } /* Fuerza el ancho del nombre */
    </style>
</head>
<body>
...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="ComisionController.php?action=create" class="btn btn-success">Registrar Nueva Comisión</a>
    </div>
                ...
                <?php else: ?>
                    <?php foreach ($comisiones as $comision): ?>
                        <tr>
                            ...
                            <td>
                                <a href="ComisionController.php?action=edit&id=<?php echo $comision['idComision']; ?>" class="btn btn-sm btn-primary me-2">Editar</a>
                                <a href="ComisionController.php?action=delete&id=<?php echo $comision['idComision']; ?>" 
